...
Cadence 1.0.0 (build 3) is the first public release, for Apple silicon and
...
| Goal | Page |
| --- | --- |
| Install or begin | [Getting Started](Getting-Started) |
| Explore features | [Feature Overview](Feature-Overview) |
| Organize music | [Library and Import](Library-And-Import) |
| Understand privacy | [Privacy and Security](Privacy-And-Security) |
| Understand the system | [Architecture](Architecture) |
| Build and contribute | [Development](Development) |
| Diagnose a problem | [Troubleshooting](Troubleshooting) |
| Prepare a release | [Release Process](Release-Process) |
