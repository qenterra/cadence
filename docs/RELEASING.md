...
Cadence 1.0.2 is the current public release, for Apple silicon and macOS 26 or later. Its
...
boundaries and [release notes](../release/release-notes-1.0.2.md) for the public body.
...
1. Create an annotated release tag `v1.0.2` at the verified commit.
