...
def render(output: Path) -> None:
    ...
    centered(draw, "Cadence", 72, font(52, "semibold"), 239)
    centered(draw, "0.2.0 BETA 1  ·  APPLE SILICON", 138, font(21, "semibold"), 153)

    arrow_y = 424
    draw.line((555, arrow_y, 735, arrow_y), fill=(151, 151, 151, 255), width=5)
    draw.line((702, arrow_y - 26, 735, arrow_y), fill=(151, 151, 151, 255), width=5)
    draw.line((702, arrow_y + 26, 735, arrow_y), fill=(151, 151, 151, 255), width=5)

    centered(draw, "Drag Cadence to Applications", 618, font(29, "semibold"), 225)
    centered(draw, "macOS 26+  ·  ad-hoc signed  ·  not notarized", 670, font(20), 151)
